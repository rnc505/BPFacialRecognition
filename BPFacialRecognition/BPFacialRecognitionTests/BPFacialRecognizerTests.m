...
-(void)testRecognize {
    ...
    BPRecognitionResult* result1 = [self.recognizer recognizeUnknownPerson:[UIImage imageWithFilename:@"test10" withExtension:@"png"]];
    XCTAssertEqualObjects(SilentBob, [result1 person], @"People don't equal");
    NSLog(@" ");
}
#endif
